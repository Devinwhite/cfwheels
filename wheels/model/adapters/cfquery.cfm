<cffunction name="$executeQuery" returntype="struct" access="public" output="false">
	...
	<cfargument name="AppendSql" type="string" required="true">
	<cfscript>
